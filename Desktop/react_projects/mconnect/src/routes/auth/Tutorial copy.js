...
const Tutorial = ({ ...props }) => {
  ...
  const texts = [
    `
      ...
      <div style="font-size: 1.75rem; line-height: 2rem; margin-top: 2rem" ><span style="font-size: 1.25rem;">Connects</span>는 일상에서 발견한</div>
      ...
      <div style="font-size: 1.75rem; line-height: 2rem; margin-top: 2rem">사용자가 <span style="color: #fca5a5">새로운 아이디어</span>를</div>
    ...
    `
      ...
      <div style="font-size: 1.75rem; line-height: 2rem; margin-top: 2rem">다른 사람들의 다양한 아이디어를</div>
      <div style="font-size: 1.75rem; line-height: 2rem"><span style="color: #f87171">탐색하고 저장</span>하세요</div>
      <div style="font-size: 1.75rem; line-height: 2rem; margin-top: 2rem"><span style="color: #fca5a5">수집한 아이디어들을 서로 연결</span>해</div>
